...
const ServiceData = [
	{
		...
		body: [
			...
			"<p>The pandemic has transformed what the marketing team means to an organization: It is given us agency. It is upended the customer journey. It is redefined how sales and marketing teams should interact. And it is forced businesses to see the value that marketers provide in a digital world.</p> <h2>This is our new heading</h2> <Image src='https://wallpapercave.com/wp/wp2856658.jpg' />",
		],
	},

	{
		...
		image: '/images/10_thumb.jpg',
		icon: '/images/icon-1.svg',
		title: 'Highly scalable modern hybrid android application development',

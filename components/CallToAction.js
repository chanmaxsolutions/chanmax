...
<div className='container home-call-to-action-container p-5'>
            <div className='row'>
                <div className='col-md-10'>
                <h1 className='text-white mt-4'>Have an idea to build a digital product?</h1>
                <p className='text-white small'>build a digital product an idea to build a digital product an idea to

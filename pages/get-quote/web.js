			...
			<div className="container contact-details-container">
				<div className="row justify-content-md-center">
						...
						Object.keys(state[0]).map((data) => (
							<div
								style={{
									width: 150,
									height: 150,
									border: `1px solid ${state[0][data]['status'] ? 'red' : 'black'}`,
									fontSize: 20,
									textAlign: 'center',
									margin: 4,
								}}
						...
						Object.keys(state[1]).map((data) => (
							<div
								style={{
									width: 150,
									height: 150,
									border: `1px solid ${state[1][data]['status'] ? 'red' : 'black'}`,
									fontSize: 20,
									textAlign: 'center',
									margin: 4,
								}}
						...
						Object.keys(state[2]).map((data) => (
							<div
								style={{
									width: 150,
									height: 150,
									border: `1px solid ${state[2][data]['status'] ? 'red' : 'black'}`,
									fontSize: 20,
									textAlign: 'center',
									margin: 4,
								}}
					...
					<form noValidate className="mt-4">
						<input type="text" onChange={handleChange} value={values.name} name="name" placeholder="Your Name" className="form-control" />
						<br />
						<input type="text" onChange={handleChange} value={values.email} name="email" placeholder="Email Address" className="form-control" />
						<br />
						<input type="text" onChange={handleChange} value={values.company} name="company" placeholder="Company Name" className="form-control" />
						<br />
						<input type="text" onChange={handleChange} value={values.phone} name="phone" placeholder="Your Phone Number" className="form-control" />
